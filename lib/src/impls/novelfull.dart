...
class NovelFull extends Crawler with CleanHtml, ParseNovel {
  ...
  Future<Novel> fetchNovel(String url) async {
    ...
    final novel = Novel(
      ...
      author: doc.selectAllText("a[href^='/author']").join(","),
      thumbnailUrl:
          thumbnailUrl == null ? null : meta.absoluteUrl(thumbnailUrl),
      description: doc.selectAllText(".desc-text > p"),
      url: url,
      lang: _meta.lang,
      volumes: await volumes(url, doc, hasChapterOptionsUrl),
    );
